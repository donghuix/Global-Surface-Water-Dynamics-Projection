...
CASE_NAME=ELMMOS_GLOBE_Surface_Water_${GIT_HASH}_cal09_compy.`date "+%Y-%m-%d-%H%M%S"`
...
cat >> user_nl_elm << EOF
fsurdat = '/compyfs/xudo627/Global-Surface-Water-Dynamics-Projection/inputdata/surfdata_GLOBE_cal_09.nc'
