...
CASE_NAME=GLOBE_Surface_Water_Projection_cal12_${FORCING}_${SCENARIO}_${GIT_HASH}.`date "+%Y-%m-%d-%H%M%S"`
...
./xmlchange CIME_OUTPUT_ROOT=/global/cfs/projectdirs/m3780/donghui/Global-Surface-Water-Dynamics-Projection/scripts/cal12/outputs
...
finidat_rtm = '/global/cfs/projectdirs/m3780/donghui/Global-Surface-Water-Dynamics-Projection/scripts/cal12/outputs/GLOBE_Surface_Water_Projection_cal12_mpi-esm1-2-hr_historical_0b7cdf4760.2024-05-08-114235.mosart.r.2015-01-01-00000.nc'
inundflag = .true.
opt_elevprof = 1
routingmethod = 2
EOF
...
finidat = '/global/cfs/projectdirs/m3780/donghui/Global-Surface-Water-Dynamics-Projection/scripts/cal12/outputs/GLOBE_Surface_Water_Projection_cal12_mpi-esm1-2-hr_historical_0b7cdf4760.2024-05-08-114235.elm.r.2015-01-01-00000.nc'
