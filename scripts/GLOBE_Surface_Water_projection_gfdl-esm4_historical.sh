...
./xmlchange LND_DOMAIN_FILE=domain_lnd_GLOBAL_calibrated.nc
./xmlchange ATM_DOMAIN_FILE=domain_lnd_GLOBAL_calibrated.nc
...
frivinp_rtm = '/global/cfs/projectdirs/m3780/donghui/Global-Surface-Water-Dynamics-Projection/inputdata/MOSART_GLOBAL_calibrated.nc'
...
cat >> user_nl_elm << EOF
fsurdat = '/global/cfs/projectdirs/m3780/donghui/Global-Surface-Water-Dynamics-Projection/inputdata/surfdata_GLOBAL_calibrated.nc'
