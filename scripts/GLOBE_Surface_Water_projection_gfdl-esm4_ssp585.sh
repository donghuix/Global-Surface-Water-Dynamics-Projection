...
flanduse_timeseries = '/global/cscratch1/sd/donghui/landuse/landuse.timeseries_CONUS_calibrated_${SCENARIO}_simyr2015-2100_c220214.nc'
...
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/CO2@/project/projectdirs/m3780/donghui/inputdata/CO2@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.co2tseries.SSP5-8.5 
