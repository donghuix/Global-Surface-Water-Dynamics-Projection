...
CASE_NAME=Surface_Water_Projection_${FORCING}_${SCENARIO}_${GIT_HASH}.`date "+%Y-%m-%d-%H%M%S"`
...
./xmlchange LND_DOMAIN_FILE=domain_lnd_CONUS_calibrated.nc
./xmlchange ATM_DOMAIN_FILE=domain_lnd_CONUS_calibrated.nc
./xmlchange LND_DOMAIN_PATH=/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata
./xmlchange ATM_DOMAIN_PATH=/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata
#./xmlchange CIME_OUTPUT_ROOT=/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/outputs
...
#./xmlchange REST_N=40,REST_OPTION=nyears
./xmlchange JOB_QUEUE=regular
./xmlchange NTASKS=320
./xmlchange JOB_WALLCLOCK_TIME=48:00:00

./preview_namelists

cat >> user_nl_mosart << EOF
frivinp_rtm = '/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata/MOSART_CONUS_calibrated.nc'
finidat_rtm = '/global/cscratch1/sd/donghui/e3sm_scratch/cori-haswell/Surface_Water_Projection_gfdl-esm4_historical_ac5e794b7d.2022-02-23-133534/run/Surface_Water_Projection_gfdl-esm4_historical_ac5e794b7d.2022-02-23-133534.mosart.r.0041-01-01-00000.nc'
...
cat >> user_nl_elm << EOF
fsurdat = '/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata/surfdata_CONUS_calibrated.nc'
finidat = '/global/cscratch1/sd/donghui/e3sm_scratch/cori-haswell/Surface_Water_Projection_gfdl-esm4_historical_ac5e794b7d.2022-02-23-133534/run/Surface_Water_Projection_gfdl-esm4_historical_ac5e794b7d.2022-02-23-133534.elm.r.0041-01-01-00000.nc'
flanduse_timeseries = '/global/cscratch1/sd/donghui/landuse/landuse.timeseries_CONUS_calibrated_${SCENARIO}_simyr2015-2100_c220318.nc'
check_dynpft_consistency = .false.
use_frac_h2osfc_act = .true.
...
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/CO2@/project/projectdirs/m3780/donghui/inputdata/CO2@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.co2tseries.SSP1-2.6 
...
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Precip@/project/projectdirs/m3780/donghui/lnd-rof-2way-fut/data/forcings/NLDAS/${FORCING}/${SCENARIO}/Prec@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Precip
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516@/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Precip
perl -w -i -p -e "s@domain.lnd.360x720_gswp3.0v1.c170606.nc@domain.lnd.NLDAS_0.5x0.5_isimip.3b.c211109.nc@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Precip
...
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/Solar@/project/projectdirs/m3780/donghui/lnd-rof-2way-fut/data/forcings/NLDAS/${FORCING}/${SCENARIO}/Solr@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Solar
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516@/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Solar
perl -w -i -p -e "s@domain.lnd.360x720_gswp3.0v1.c170606.nc@domain.lnd.NLDAS_0.5x0.5_isimip.3b.c211109.nc@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.Solar
...
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/TPHWL@/project/projectdirs/m3780/donghui/lnd-rof-2way-fut/data/forcings/NLDAS/${FORCING}/${SCENARIO}/TPQWL@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.TPQW
perl -w -i -p -e "s@/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.GSWP3.0.5d.v1.c170516@/project/projectdirs/m3780/donghui/Runoff_Projection_Uncertainty/inputdata@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.TPQW
perl -w -i -p -e "s@domain.lnd.360x720_gswp3.0v1.c170606.nc@domain.lnd.NLDAS_0.5x0.5_isimip.3b.c211109.nc@" ${CASE_DIR}/${CASE_NAME}/user_datm.streams.txt.CLMGSWP3v1.TPQW
